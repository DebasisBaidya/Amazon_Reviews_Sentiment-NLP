...
# Emojis corresponding to sentiment classes for display
emoji_dict = {
    "Positive": "😃✨💖",
    "Neutral": "😐🌀🤷",
    "Negative": "👿💢👎"
...
# List of keywords indicating neutral sentiment to override model prediction
neutral_keywords = [
...
<div style='text-align: center; padding: 15px; border: 1px solid #ddd; border-radius: 10px;'>
    ...
    <p style='font-size:14px;'>Classify product reviews as <b style='color:green;'>Positive</b>, <b style='color:orange;'>Neutral</b>, or <b style='color:red;'>Negative</b></p>
</div>
